...
class VendingMachine:
    ...
    def __init__(self, shop, shop_price):
        self.shop = shop
        self.shop_price = shop_price
        
    def restock(self, stock):
        self.shop_stock += stock
        return f'Current {self.shop} stock: {self.shop_stock}'
    
    def add_funds(self, money):
        if self.shop_stock == 0:
    ...
    def vend(self):
        ...
        change = self.current_balance - self.shop_price
        if change < 0:
            ...
            self.shop_stock -= 1
            if change > 0:
                return f'Here is your {self.shop} and ${change} change.'
            else:
                return f'Here is your {self.shop}.'
...
def two_list(vals, counts):
    ...
    for i in range(length):
        lnk = two_list(vals[i + 1:], counts[i + 1:])
